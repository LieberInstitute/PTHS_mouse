...
dim(outGene) #12768 background genes
sigGene = with(outGene,outGene[which(padj < 0.05 &!is.na(padj)),])
dim(sigGene) #1370 DEGs
...
nrow(humanSFARI) # 585 expressed in mouse tcf4 dataset
...
WriteXLS(sfariList,ExcelFileName = 'tcf4_mouse/tables/stable7_SFARI_asd_gene_list.xls')
