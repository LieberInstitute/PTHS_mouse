...
pdf('tcf4_mouse/plots/fig2_expression_plots.pdf',width = 6, height = 5.5)
...
###############
# volcano plots
outGene$col = '#A9A9A950' #black
outGene$col[outGene$pvalue<0.01] = '#FFC0CB80' #pink
...
plot( outGene$baseMean,outGene$log2FoldChange,pch = 20, col =outGene$col,log = 'x',
     xlab = 'Normalized Mean Counts', ylab = 'Log2 Fold-change',ylim = c(-.6, .6))
abline(h = 0, lty = 1, col = 'red')
legend('topright', legend = c('FDR < 0.05','pvalue < 0.01'), pch = 20, col = c('#ff0000','#FFC0CB80'))
dev.off()
